...
<div class="control-group">
<label class="control-label" for="basicinput">Tên nhà phát hành</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Giá sản phẩm sau khi giảm giá</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Giá giao hàng của sản phẩm</label>
<div class="controls">
