...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Danh mục con </a></li>
						...
						<ul class="widget widget-menu unstyled">
							<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>Người dùng đăng nhập </a></li>
