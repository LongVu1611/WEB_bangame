...
<html lang="en">
	<head>
	    ...
	    <title>Game Bruhh Home Page</title>
    ...
    <body class="cnt-home" style="background-color:bisque">
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Miễn phí giao hang cho hóa đơn trên 500 VNĐ</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Siêu khuyến mãi!!</h4>
						</div>
					</div>
					<h6 class="text">Giảm 20% tất cả sản phẩm !!</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Sản phẩm nổi bật</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#furniture" data-toggle="tab">Playstation</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				...
				<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Add to Cart</a></div>
				<?php } else {?>
						<div class="action" style="color:greenyellow">In Stock</div>
					<?php } ?>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Playstation</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Game PC</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
